...
export interface ZDB<Content extends {} = {}> {
  ...
  find(request: PouchDB.Find.FindRequest<Content>,
    callback: PouchDB.Core.Callback<PouchDB.Find.FindResponse<Content>>): void;
  find(request?: PouchDB.Find.FindRequest<Content>): Promise<PouchDB.Find.FindResponse<Content>>;
