...
var AuthBridge = /** @class */ (function () {
    ...
    AuthBridge.prototype.on = function (eventName, listener) {
        this._eventEmitter.on(eventName, listener);
        return this;
    };
    ;
    AuthBridge.prototype.removeListener = function (eventName, listener) {
    ...
    // Status methods
    // *********************************
    AuthBridge.prototype.isUserLoggedIn = function () {
    ...
    ;
    AuthBridge.prototype.getAuthToken = function () {
        var token = 'Bearer ' + this.state.user.idTokenRAW;
        return token;
    };
    ;
    AuthBridge.prototype.getUserData = function () {
